            ...
            'form' => array(
                ...
                'input'   => array(
                    ...
                    array(
                        ...
                        'class' => 't',
                        'type' => 'text',
                        'desc' => $this->l('RENAME categories as Yandex.Market categories (ex. 2:category name,)'),
                        'name' => 'YA_MARKET_REPLACE_TEXT',
                        'label' => $this->l('category ID:new string name, comma to separate'),
                    ),
                    array(
                        'col' => 4,
                        'class' => 't',
                        'type' => 'text',
                        'desc' => $this->l('UNION categories to one Yandex.Market category (ex. 2:3,5:6)'),
                        'name' => 'YA_MARKET_TO_UNION',
                        'label' => $this->l('category to remove ID:category to union with ID, comma to separate'),
                    ),
					//** patched **					
                    array(
                        'col'   => 4,
